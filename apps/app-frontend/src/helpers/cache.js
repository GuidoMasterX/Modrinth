...
export async function get_curseforge_search_results(id, cacheBehaviour) {
	return await invoke('plugin:cache|get_curseforge_search_results', { id, cacheBehaviour })
}

export async function get_curseforge_categories(cacheBehaviour) {
	return await invoke('plugin:cache|get_curseforge_categories', { cacheBehaviour })
}

export async function get_curseforge_project(id, cacheBehaviour) {
	return await invoke('plugin:cache|get_curseforge_project', { id, cacheBehaviour })
}

export async function get_curseforge_project_versions(id, cacheBehaviour) {
