...
export { default as ProjectSidebarDependencies } from './ProjectSidebarDependencies.vue'
...
export { default as ProjectSidebarModpacks } from './ProjectSidebarModpacks.vue'
export { default as ProjectSidebarRepository } from './ProjectSidebarRepository.vue'
